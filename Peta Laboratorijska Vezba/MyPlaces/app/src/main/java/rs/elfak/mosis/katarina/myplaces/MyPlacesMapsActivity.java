...
public class MyPlacesMapsActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        {
            MenuItem item = menu.add(0, 1, 1, "Select Coordinates");
            item.setIcon(R.drawable.outline_add_location_white_24dp);
    ...
    private void showMyPlaces()
    {
        ...
        for(int i = 0; i<MyPlacesData.getInstance().getMyPlaces().size(); i++)
        {
            ...
            item.setMarker(this.getResources().getDrawable(R.drawable.outline_beenhere_black_24dp));
            Toast.makeText(this, "Marker set", Toast.LENGTH_SHORT).show();
            items.add(item);
        }
